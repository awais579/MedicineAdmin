    ...
    return (
        <>
            <div className="content-section p-3">
                <CreateCategory Modal={Modal} Button={Button} modalOpen={modalOpen} setModalOpen={setModalOpen} />
                            ...
                            <div className="card-body">
                                ...
                                <div className="table-responsive">
                                    ...
                                    >
                                        ...
                                        <thead>
                                            <tr >
                                                <th className="sorting" tabIndex="0" aria-controls="warehouse_table" rowspan="1" colspan="1" style={{ width: "105px" }} aria-label="Name: activate to sort column ascending">Medicine</th>
