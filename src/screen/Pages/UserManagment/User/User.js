                                ...
                                >
                                    <thead>
                                        <tr>
                                            ...
                                            <th style={{ width: "105px" }}>Account Type</th>
                                    ...
                                    <tbody>
                                        <tr>
                                            ...
                                            <td>Ahmed</td>
                                            <td>
                                                <i className="fa-solid text-danger fa-trash " style={{cursor:'pointer'}} > </i>
                                                <i className="fa-solid text-warning fa-pen-to-square ms-2 " style={{cursor:'pointer'}}></i>
                                            </td>
                                        </tr>
